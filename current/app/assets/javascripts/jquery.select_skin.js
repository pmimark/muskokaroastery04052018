 ...
 * Modified April 2011 by Robert McLarty (robert@overdrivedesign.com)
 */
  ...
  $.fn.select_skin = function (w) {
    return $(this).each(function(i) {
      ...
      if (!s.attr('multiple')) {
        ...
        s.wrap('<div class="custom-select-container"></div>');
        c = s.parent();
        c.children().before('<div class="custom-select-label">&nbsp;</div>').each(function() {
        ...
        t.height(
          c.outerHeight() -
          s.css('padding-top').replace(/px,*\)*/g,"") -
          s.css('padding-bottom').replace(/px,*\)*/g,"") -
          t.css('padding-top').replace(/px,*\)*/g,"") -
          t.css('padding-bottom').replace(/px,*\)*/g,"") -
          2
        );
        t.width(
          c.innerWidth() -
          s.css('padding-right').replace(/px,*\)*/g,"") -
          s.css('padding-left').replace(/px,*\)*/g,"") -
          t.css('padding-right').replace(/px,*\)*/g,"") -
          t.css('padding-left').replace(/px,*\)*/g,"") -
          c.innerHeight()
        );
